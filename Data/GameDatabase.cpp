...
namespace FGameDatabase 
{
    ...
    {
        {"고블린 정찰병", 160, 15, 8,   30, 50,  4000,  "부러진 단검", 15, 50}, // 50% 확률
        {"오크 흑마법사", 200, 25, 10,  50, 80,  7000,  "오크의 어금니", 30, 40}, // 40% 확률
        {"포악한 트롤",   280, 20, 5,   80, 120, 11000, "끈적한 액체", 50, 60}, // 60% 확률
        {"해골 기사",     350, 30, 12, 100, 150, 16000, "녹슨 철퇴", 80, 30}  // 30% 확률
    };
